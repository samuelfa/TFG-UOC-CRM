...
('20200510102343', '2020-05-10 10:23:43'),
('20200510102344', '2020-05-10 10:23:44'),
('20200513174647', '2020-05-13 17:46:47')
;

ALTER TABLE activities CHANGE start_at start_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', CHANGE finish_at finish_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)'